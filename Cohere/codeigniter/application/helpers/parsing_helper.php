									...
									<div class="col-sm-12">
										<div class="row">
											<a href="' . base_url('snapshots/' . $row['snapshotSlug']).'" class="ajax relative" style="display:block">
												...
												<img width="100%" class="img-responsive" src="' . base_url('uploads/snapshots/' . imageCheck('snapshots', $row['snapshotFile'], 1)).'" alt="'.truncate($row['snapshotContent'], 80).'"/>
											</a>
										</div>
										<br />
										<p>
								...
								<div class="row">
									<div class="col-sm-12">
										...
										<p class="meta">
											...
											<a href="' . base_url('openletters/' . $row['slug']) . '" class="ajaxLoad btn btn-default pull-right"><i class="fa fa-envelope"></i> ' . phrase('view_answer') . '</a>
										</p>
									</div>
								</div>
