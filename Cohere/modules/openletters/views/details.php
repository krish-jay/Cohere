	...
	<div class="container">
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="image-placeholder-sm">
					...
					<div id="appendComment">
						<div class="col-xs-12">
							<div class="btn-group btn-group-justified">
								<a href="javascript:void(0)" class="btn btn-default"><i class="fa fa-comments"></i> <span class="comments-count-openletters<?php echo $page['letterID']; ?>"><?php echo countComments('openletters', $page['letterID']); ?></span> <span class="hidden-xs"><?php echo phrase('answers'); ?></span></a>
					...
					<div class="col-sm-12">
						...
						<?php
							echo getAnswers('openletters', $page['letterID']);
						?>
		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<h4><i class="fa fa-ellipsis-v"></i> &nbsp; <?php echo phrase('related_questions'); ?></h4>
