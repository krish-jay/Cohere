	...
	<div class="bg-info">
		<div class="container first-child">
			<div class="row">
				...
				<div class="col-md-3">
					<a href="<?php echo base_url('user/openletters/add'); ?>" class="btn btn-lg btn-block btn-primary newPost" data-toggle="modal"><i class="fa fa-plus"></i> &nbsp; <?php echo phrase('ask_a_question'); ?></a>
				</div>
			</div>
		</div>
	</div>
								...
								<div class="blog_article">
									...
									<div class="row">
										...
										<div class="col-sm-5">
											...
											<div class="row">
												<div class="col-sm-12">
													<a href="' . base_url('openletters/' . $c['slug']) . '" class="ajaxLoad btn btn-default btn-block"><i class="fa fa-envelope"></i> ' . phrase('view_answers') . '</a>
												</div>
											</div>
										</div>
									</div>
