				...
				<div class="text-center-xs">
					<div class="btn-group btn-group-sm-justified">
						...
						<?php if($page['contributor'] == $this->session->userdata('userID') || $this->session->userdata('user_level') == 1) { ?>
							<a href="<?php echo base_url('user/posts/edit/' . $page['postSlug']); ?>" class="btn btn-success btn-sm newPost" data-toggle="modal" style="margin-top:0"><b><i class="fa fa-edit"></i> <?php echo phrase('edit'); ?></b></a>
						<?php } ?>
