		...
		<div class="container first-child">
			<div class="row">
				...
				<div class="col-md-3">
					...
					<?php } else { ?>
						<a href="<?php echo base_url('user/snapshots/add'); ?>" class="btn btn-lg btn-block btn-primary newPost" data-toggle="modal"><i class="fa fa-upload"></i> &nbsp; <?php echo phrase('upload_snapshot'); ?></a>
					<?php } ?>
				</div>
			</div>
		</div>
								...
								<div class="col-sm-9 sticky">
									<div class="first image-placeholder">
										<a href="' . base_url('snapshots/' . $c['snapshotSlug']).'" class="ajax relative" style="display:block">
											...
											<img width="100%" class="img-responsive rounded-top" style="margin:0;" src="' . base_url('uploads/snapshots/' . imageCheck('snapshots', $c['snapshotFile'], 1)) . '" alt="' . truncate($c['snapshotContent'], 30) . '"/>
										</a>
										<div class="col-sm-12">
											<p>
