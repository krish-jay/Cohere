				<div class="row">
					<div class="col-sm-12">
						<div class="list-group">
							...
							<a href="<?php echo base_url('user/posts'); ?>" class="ajaxLoad list-group-item<?php if($this->uri->segment(2) == 'posts') echo ' active'; ?>"><i class="fa fa-newspaper-o"></i> &nbsp; <?php echo phrase('Blogs'); ?> &nbsp; <?php echo (countPosts('posts', ($this->session->userdata('user_level') == 1 ? null : $this->session->userdata('userID'))) > 0 ? '<span class="badge">' . countPosts('posts', ($this->session->userdata('user_level') == 1 ? null : $this->session->userdata('userID'))) . '</span>' : '') ?></a>
