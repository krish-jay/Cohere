			...
			<div class="row">
				...
				<div class="col-sm-3">
					...
					<?php } else { ?>
						...
						<a class="btn btn-lg btn-block btn-primary disabled" href="<?php echo base_url('user/connect'); ?>"><i class="fa fa-facebook"></i> &nbsp; <?php echo phrase('connect_to_facebook'); ?></a>
		...
		<div class="row">
			...
			<div class="col-md-7 sticky">
				<form action="<?php echo base_url('user/edit_profile'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal submitForm" data-save="<?php echo phrase('update'); ?>" data-saving="<?php echo phrase('updating'); ?>" data-alert="<?php echo phrase('unable_to_update_profile'); ?>">
					...
					<div class="form-group">
						<label class="control-label col-sm-4"><?php echo phrase('designation'); ?></label>
						<div class="col-sm-8">
							<input type="text" class="form-control" name="designation" value="<?php echo set_value('designation', $row['designation']); ?>" />
							<?php echo form_error('designation', '<div class="alert alert-danger">', '</div>'); ?>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4"><?php echo phrase('organisation'); ?></label>
						<div class="col-sm-8">
							<input type="text" class="form-control" name="organisation" value="<?php echo set_value('organisation', $row['organisation']); ?>" />
							<?php echo form_error('organisation', '<div class="alert alert-danger">', '</div>'); ?>
						</div>
					</div>
