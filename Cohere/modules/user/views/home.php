	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-7 sticky">
				...
				<div class="separator">
					<span class="text-muted"><?php echo phrase('let_your_enlightment_to_all'); ?> </span>
				</div>
					...
					<div class="col-sm-7 sticky">
						<div class="image-placeholder">
							<div class="col-sm-12">
								...
								<br /><br />
								<h4><i class="fa fa-paperclip"></i> &nbsp;<?php echo phrase('new_from_blogs'); ?></h4>
									
								<?php echo widget_sidebarNews(); ?>
								
								<br />
								<a href="<?php echo base_url('posts'); ?>" class="ajaxLoad btn btn-default btn-block"><i class="fa fa-list"></i> <?php echo phrase('read_another_blogs'); ?></a>
							</div>
						</div>
					</div>
				</div>
