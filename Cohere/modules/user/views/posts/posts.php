	...
	<div class="bg-info">
		<div class="container first-child">
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="col-12-xs">
						<a href="<?php echo base_url('user/posts/add'); ?>" class="btn btn-lg btn-block btn-primary newPost" data-toggle="modal"><i class="fa fa-plus"></i> &nbsp; <?php echo phrase('write_article'); ?></a>
					</div>
				</div>
			</div>
		</div>
								...
								echo '
									<tr id="post' . $c['postID'] . '">
										...
										<td class="text-right col-xs-4">
											<div class="btn-group">
												<a class="btn btn-default btn-sm newPost" data-toggle="modal" href="' . base_url('user/posts/edit/' . $c['postSlug']) . '" data-push="tooltip" data-placement="top" title="' . phrase('edit_post') . '"><i class="btn-icon-only fa fa-edit"> </i></a>
