			...
			<div class="col-sm-10 col-sm-offset-1">
				<form action="<?php echo current_url(); ?>" method="post" class="form-horizontal submitForm" data-save="<?php echo phrase('save'); ?>" data-saving="<?php echo phrase('saving'); ?>" data-alert="<?php echo phrase('unable_to_add_article'); ?>">
					...
					<div class="modal-footer">
						<p class="text-left"><i class="fa fa-info-circle"></i> <?php echo phrase('to_access_more_features_in_writting_article_use_desktop_view'); ?></p>
						<div class="form-group">
							<div class="col-xs-6 nomargin text-left">
								...
								<?php } else { ?>
									<a href="<?php echo base_url($this->session->userdata('userName')); ?>" class="btn btn-default btn-lg ajaxLoad"><i class="fa fa-times"></i> <?php echo phrase('cancel'); ?></a>
								<?php } ?>
							</div>
