						...
						<form action="<?php echo base_url('user/updates'); ?>" method="post" class="form-horizontal image-placeholder rounded bordered" id="addUpdateForm">
							<div class="col-sm-12">
								...
								<div class="control-group row statusHolder">
									<div class="col-xs-4">
										<div class="btn-group">
											<a href="<?php echo base_url('user/snapshots/add'); ?>" data-push="tooltip" data-placement="top" data-title="<?php echo phrase('upload_a_snapshot'); ?>" class="btn btn-default newPost" data-toggle="modal"><i class="fa fa-image"></i></a>
											<a href="<?php echo base_url('user/posts/add'); ?>" data-push="tooltip" data-placement="top" data-title="<?php echo phrase('write_new_article'); ?>" class="btn btn-default newPost" data-toggle="modal"><i class="fa fa-newspaper-o"></i></a>
										</div>
									</div>
