	...
	<div class="jumbotron" style="background:url(<?php echo base_url('uploads/users/covers/' . imageCheck('covers', getUserCover($page['userID']))); ?>) center center no-repeat;background-size:cover;-webkit-background-size:cover;background-position:fixed;padding-top:330px;padding-bottom:0;margin-bottom:0;width:100%"></div>
					...
					<form id="photoUpload" action="<?php echo base_url('user/uploads/photo'); ?>" method="post" enctype="multipart/form-data">
						<div data-provides="fileupload" class="btn btn-file fileupload fileupload-new userImage" style="padding:0">
							<div class="fileupload-new" style="overflow:hidden">
								<div class="col-xs-6 col-xs-offset-3 col-sm-12 col-sm-offset-0 text-center" style="padding:10">
									<div class="rounded" style="width:100%;border:5px solid #eee;overflow:hidden">
							...
							<div class="col-sm-6 col-sm-offset-3">
								...
								<div class="modal-body">
									<div class="form-horizontal">
										...
										<div class="form-group">
											<label class="control-label col-xs-1 col-xs-offset-1 text-left"><i class="fa fa-briefcase"></i></label>
											<div class="col-xs-9">
												<?php echo $page['designation']; ?>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-xs-1 col-xs-offset-1 text-left"><i class="fa fa-building-o"></i></label>
											<div class="col-xs-9">
												<?php echo $page['organisation']; ?>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-xs-1 col-xs-offset-1 text-left"><i class="fa fa-envelope"></i></label>
											<div class="col-xs-9">
												<?php echo $page['email']; ?>
											</div>
										</div>
										...
										<div class="form-group">
											<label class="control-label col-xs-1 col-xs-offset-1 text-left"><i class="fa fa-graduation-cap"></i></label>
											<div class="col-xs-9">
												<?php echo $page['year'] . ' ' . phrase('batch'); ?>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-xs-1 col-xs-offset-1 text-left"><i class="fa fa-institution"></i></label>
											<div class="col-xs-9">
												<?php echo $page['branch']; ?>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-sm-6 col-sm-offset-3">
								...
								<form action="<?php echo base_url('user/edit_profile'); ?>" method="post" class="form-horizontal submitForm" data-save="<?php echo phrase('update'); ?>" data-saving="<?php echo phrase('updating'); ?>" data-alert="<?php echo phrase('unable_to_update_your_profile'); ?>">
									<div class="modal-body">
										...
										<div class="form-group">
											<label class="control-label col-sm-4 text-right"><?php echo phrase('current_status'); ?></label>
											<div class="col-sm-6">
												<input type="text" class="form-control" name="designation" value="<?php echo $page['designation']; ?>" />
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-sm-4 text-right"><?php echo phrase('organisation'); ?></label>
											<div class="col-sm-6">
												<input type="text" class="form-control" name="organisation" value="<?php echo $page['organisation']; ?>" />
											</div>
										</div>
