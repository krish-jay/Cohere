						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<select name="gender" class="form-control">
									...
									<option value="l"<?php if($page['gender'] == 'male') echo ' selected'; ?>><?php echo phrase('man'); ?></option>
									<option value="p"<?php if($page['gender'] == 'female') echo ' selected'; ?>><?php echo phrase('woman'); ?></option>
								</select>
							</div>
						</div>
						<div class="form-group">
