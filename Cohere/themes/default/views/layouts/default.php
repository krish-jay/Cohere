...
<html lang="en-US" class="no-js" prefix="og: http://ogp.me/ns#">
	...
	<body class="fixed">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-8 nomargin nopadding text-center pushTitle" style="color:#fff;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;line-height:60px">
						<a class="navbar-brand ajaxLoad" href="<?php echo base_url(); ?>"><img src="<?php echo base_url('themes/default/images/logo.png'); ?>" alt="logo" height="100%" /></a><?php echo truncate($meta['title'], 160); ?>
					</div>
		...
		<div class="menu-left navmenu navmenu-default navmenu-fixed-left">
			<div style="line-height:60px;font-weight:bold;text-transform:uppercase;color:#fff;text-align:center;padding:0 15px"><?php echo phrase('menu'); ?></div>
			<ul class="navmenu-nav">
				...
				<li>
					<a href="<?php echo base_url('search'); ?>" class="ajaxLoad"><i class="fa fa-search"></i> <?php echo phrase('search'); ?></a>
				</li>
						
				<?php if($this->session->userdata('loggedIn')) { ?>
				
				<li>
					<a href="<?php echo base_url(getUsernameByID($this->session->userdata('userID'))); ?>" class="ajaxLoad"><i class="fa fa-user"></i>  <?php echo phrase('profile'); ?></a>
				</li>
				<li>
					<a href="<?php echo base_url(getUsernameByID($this->session->userdata('userID'))); ?>" class="ajaxLoad"><i class="fa fa-desktop"></i>  <?php echo phrase('timeline'); ?></a>
				</li>
				...
				<li>
					<a href="<?php echo base_url('posts'); ?>" class="ajaxLoad"><i class="fa fa-newspaper-o"></i> <?php echo phrase(' blog'); ?></a>
				</li>
				<li>
		...
		<div class="menu-right navmenu navmenu-default navmenu-fixed-right">
			...
			<ul class="navmenu-nav">
				...
				<li>
					<a href="<?php echo base_url('user/posts'); ?>" class="ajaxLoad"><i class="fa fa-newspaper-o"></i> <?php echo phrase('blogs'); ?><span class="badge more"><?php echo countPosts('posts', ($this->session->userdata('user_level') == 1 ? null : $this->session->userdata('userID'))); ?></span></a>
				</li>
				<li>
					...
					<div class="modal-body" style="padding-top:0;padding-bottom:0">
						<div class="row">
							...
							<div class="col-sm-5 nomargin loginBorder text-center">
								<br /><br />
			<a class="btn btn-primary btn-lg btn-block" href="<?php echo base_url('user/forget'); ?>"><i class="fa fa-unlock"></i> &nbsp; <?php echo phrase('forget_password'); ?></a>
			...
			<div class="modal-dialog modal_table" style="max-width:480px">
				<div class="modal-content modal_cell">
					...
					<div class="modal-footer text-center">
						...
						<?php echo phrase('we_will_update_more_languages_soon...'); ?>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="row">
							...
							<div class="col-sm-12">
								<form class="form-horizontal submitForm" action="<?php echo base_url('users'); ?>" method="post" data-save="<?php echo phrase('search'); ?>" data-saving="<?php echo phrase('searching'); ?>" data-alert="<?php echo phrase('unable_to_submit_inquiry'); ?>">
									<div class="input-group">
										<input type="text" class="form-control input-lg" name="query" placeholder="<?php echo phrase('serach_user'); ?>" />
										<span class="input-group-btn">
											<input type="hidden" name="hash" value="<?php echo sha1(time()); ?>" />
											<button type="submit" class="btn btn-lg btn-success nomargin submitBtn"><i class="fa fa-search"></i> <?php echo phrase('search'); ?></button>
										</span>
		...
		<script type="text/javascript">
			...
			(function(d, s, id)
			{
				...
				js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.5&appId=321925145335253";
